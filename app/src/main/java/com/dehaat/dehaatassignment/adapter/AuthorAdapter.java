...
public class AuthorAdapter extends RecyclerView.Adapter<AuthorAdapter.AuthorViewHolder> {
    ...
    private AuthorItemInteractionListener authorItemInteractionListener;

    public AuthorAdapter(Context context, AuthorItemInteractionListener authorItemInteractionListener) {
